...
export default function Loader({ onNext }) {
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => {
      try {
        ...
        console.error("Loader onNext error:", e);
      }
    }, autoAdvanceMs);
  ...
  const heartbeatPath =
    "M0,50 L30,50 L35,50 L40,30 L45,70 L50,10 L55,90 L60,50 L90,50 L95,50 L100,35 L105,65 L110,15 L115,85 L120,50 L150,50 L155,50 L160,40 L165,60 L170,20 L175,80 L180,50 L210,50 L215,50 L220,45 L225,55 L230,25 L235,75 L240,50 L270,50 L275,50 L280,50 L300,50";
    ...
    <div className="min-h-screen bg-black flex items-center justify-center relative overflow-hidden p-4">
      ...
      <div className="text-center z-10">
        ...
        <motion.p
          ...
          transition={{ delay: 2 }}
        >
          This will make your heart beat faster...
        </motion.p>
